          ...
          <div className="sm:flex sm:items-start">
            ...
            <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
              ...
              <div className='flex border-2 border-black p-2 rounded-md mt-12 cursor-pointer'>
                ...
                <h1 className='font-semibold ml-20'>Continue with phone</h1>
              </div>
              ...
              <h1 className='text-center mt-4 text-xs'>If you continue, you are accepting <span className='text-blue-600'> OLX Terms and Conditions<br/> and Privacy Policy</span></h1>
              </div>
            </div>
          </div>
        </div>
